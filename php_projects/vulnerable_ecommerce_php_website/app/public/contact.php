...
if (isset($_POST['send'])){
  ...
  $Result = $Customer->SendFeedback($Name,$Email,$Subject,$Message);
  ...
  if ($Result !== True){
    ...
    $Logmsg = 'Message Sent Successfully';
  }
               ...
               <div class="col-md-8">
                 <div class="aa-contact-address-left">
                   <form class="comments-form contact-form" method="POST">
                    ...
                    <button class="aa-secondary-btn" type="submit" name="send" >Send</button>
                  </form>
                  <?php if (isset($Errmsg)){echo '<div class= "alert alert-danger" style="margin-top:80px;" >'.$Errmsg.'</div>';} ?>
                  <?php if (isset($Logmsg)){echo '<div class= "alert alert-success" style="margin-top:80px;" >'.$Logmsg.'</div>';} ?>
                 </div>
               </div>
               <div class="col-md-4">
