              ...
              <ul class="aa-product-catg">
                <?php 
                  ...
                  if (isset($_REQUEST['search'])){
                    ...
                    $SearchResults = $Product->ReturnProductsSearch($Search);
                    foreach ($SearchResults as $SearchResult) {
                      $pid = $SearchResult['product_id'];
                      $ProductName = $SearchResult['product_name'];
                      $ProductPrice = $SearchResult["price"];
                      $ProductStatus = $SearchResult["product_status"];
                      echo '  
                        ...
                        <li>
                          <figure>
                            ...
                            <figcaption>
                              ...
                              <span class="aa-product-price">$'.$ProductPrice.'</span><span class="aa-product-price"><del>$'.$ProductPrice.'</del></span>
                          ...
                          <!-- product badge -->
                          <span class="aa-badge aa-'.$ProductStatus.'" href="#">'.strtoupper($ProductStatus).'!</span>
                        </li>';
                    }
                    ...
                    $AllProducts = $Product->ReturnAllProducts();
