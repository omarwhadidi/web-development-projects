...
<header class="navbar navbar-expand-lg  navbar-dark bg-dark">
  <!-- Container wrapper -->
	<div class="container-fluid">
	    ...
	    <form class="d-flex input-group w-auto" method="GET" action="<?php echo $_SERVER['PHP_SELF'];?>">
	      <input
	        type="text"
	    ...
	    <div class="d-flex align-items-center">
	      ...
	      <!-- Avatar -->
	        <div class="dropdown">
		        ...
		        >
		          <img
		            src="<?php echo $userData['profile_pic'];?>"
		        ...
		        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuAvatar" >
		          ...
		          <li><a class="dropdown-item" href="update.php">Settings</a> </li> </li>
		          <li><hr class="dropdown-divider"></li>
	              <li><button type="submit" form="logout-form" class="dropdown-item">Sign out</button></li>
		        </ul>
	        </div>
	    </div>
	    <form id="logout-form" style="display:none" action="logout.php" method="POST">
	    	<input type="hidden" name="logouttoken" value="<?php echo $logouttoken; ?>" />
	    </form>
	    <!-- Right elements -->
