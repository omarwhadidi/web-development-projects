...
<nav class="navbar navbar-light bg-white">
        ...
        <form class="form-inline" method="GET" action="">
            <div class="input-group">
                <input type="text" class="form-control" name="searchpost" aria-label="Recipient's username" aria-describedby="button-addon2">
    ...
    <div class="container-fluid gedf-wrapper">
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        <img src="../<?php echo $userData['profile_pic'];?>" alt="..." style="margin-bottom: 10px;max-width:100%;">
